...
function setInputMode(mode) {
  inputMode = mode;
  modeButtons.forEach(b => b.classList.toggle("active", b.dataset.inputMode === mode));
}
...
function runSelfTests() {
  ...
  console.assert(modeButtons.length === 2, "input mode toggle loaded");
...
modeButtons.forEach(btn => btn.addEventListener("click", () => setInputMode(btn.dataset.inputMode)));
